            ...
            <ScrollArea className="h-full">
               <div className="p-4">
                  ...
                  {components.map((component) => (
                     ...
                     >
                        <CollapsibleTrigger
                           className="flex items-center justify-between w-full p-2 text-sm text-left text-gray-900 rounded-lg hover:bg-gray-100 font-medium focus:outline-none focus-visible:ring focus-visible:ring-purple-500 focus-visible:ring-opacity-75"
                        >
